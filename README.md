...
-   There is no exploitation of data, as the app only requires access to your accounts to fetch your unique ID for authentication/authorization purposes, and no personal details(except your registered user name on the social account) is used by the application.
...
-   Each comment has a unique identicon icon to represent the user who commented anonymously
